...
Provides resilience for external API calls with automatic failure detection and
        recovery
"""
...
class CircuitBreaker:
    ...
    def _transition_to_half_open(self):
        ...
        logger.info(
            ...
            f"attempt 1/{self.config.success_threshold}"
        )
    ...
    def _transition_to_closed(self):
        ...
        logger.info("   Service recovered, normal operation resumed")
