...
def create_custom_video_config_with_narrative(prompt, duration, platform, category, narrative, feeling):
...
def main():
    ...
    parser.add_argument('--platform', choices=['instagram', 'tiktok', 'youtube'], default='instagram', help='Target platform')
    parser.add_argument('--category', choices=['lifestyle', 'entertainment', 'education'], default='lifestyle', help='Video category')
    ...
    if args.prompt:
        ...
        from src.models.video_models import Narrative, Feeling
