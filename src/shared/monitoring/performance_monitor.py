...
class PerformanceMonitor:
    ...
    def finish_timing(self, context: TimingContext):
        ...
        self.record_metric(f"{context.name}_duration", duration, context.tags, "seconds")
    ...
    def _monitor_system_metrics(self):
        ...
        while self.system_monitoring:
            try:
                ...
                self.set_gauge("process_memory_usage", process.memory_info().rss / (1024**2), unit="MB")
...
class VideoGenerationMonitor:
    ...
    def record_step(self, tracking_id: str, step_name: str, duration: float, success: bool = True):
        """
    ...
    def finish_generation(self, tracking_id: str, success: bool = True, final_video_path: Optional[str] = None):
        """
