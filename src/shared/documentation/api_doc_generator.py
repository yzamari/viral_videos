...
class APIDocumentationGenerator:
    ...
    def __init__(self, project_root: str, output_dir: str = "docs/api"):
        ...
        logger.info(f"📚 API documentation generator initialized")
    ...
    def _extract_module_doc(self, tree: ast.AST, module_name: str, file_path: str) -> ModuleDoc:
...
def generate_api_documentation(project_root: str = ".", output_dir: str = "docs/api") -> Dict[str, Any]:
    """
    Generate comprehensive API documentation
