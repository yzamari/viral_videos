...
class YouTubeScraper:
                ...
                try:
                    ...
                    if video:
                        ...
                        if video.upload_date >= cutoff_date:
                            ...
                            logger.debug(f"Skipping video {video.title} - uploaded {video.upload_date} (before cutoff {cutoff_date})")
    ...
    def _get_mock_trending_videos(self, max_results: int = 50, category_id: Optional[str] = None, days_back: int = 6) -> List[TrendingVideo]:
