...
def log_quota_status(quota_info: Dict[str, Any]):
    ...
    if quota_info.get("comprehensive_check"):
        ...
        logger.info(f"📊 Google AI Studio: {quota_info['ai_studio']['status']} {quota_info['ai_studio']['status_emoji']}")
        logger.info(f"🎬 VEO Quota: {quota_info['veo_quota']['status']} {quota_info['veo_quota']['status_emoji']}")
        logger.info(f"☁️ Google Cloud: {quota_info['google_cloud']['status']} {quota_info['google_cloud']['status_emoji']}")
