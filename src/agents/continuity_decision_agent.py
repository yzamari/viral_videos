...
class ContinuityDecisionAgent:
    ...
    def analyze_frame_continuity_need(self, 
        ...
        try:
            ...
            analysis_prompt = f"""
You are VisualFlow, an expert AI agent specializing in frame continuity and visual storytelling flow.
...
"""
    ...
    def _make_fallback_decision(self, topic: str, category: str, platform: str, duration: int) -> Dict[str, Any]:
        ...
        return {
            ...
            'alternative_approach': "Could try opposite approach for A/B testing",
            'engagement_impact': "Moderate impact expected",
            'decision_factors': ['platform_optimization', 'duration_analysis', 'category_matching'],
            'platform_optimization': f"Optimized for {platform}",
            'visual_style_recommendation': "Standard viral style with optimized continuity",
