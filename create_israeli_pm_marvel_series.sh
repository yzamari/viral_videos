...
echo "🦸 Israeli Prime Ministers: The Marvel Chronicles"
echo "================================================="
echo "🎬 Marvel Cinematic Universe Style"
...
if [ $? -eq 0 ]; then
    ...
    python main.py generate \
      --mission "Marvel style: Levi Eshkol in war room, Six-Day War countdown like Infinity War. Generals pressure him: 'Sir, we need to attack!' Eshkol sweating like Peter Parker in suit. Hulk-transformation moment: Mild-mannered PM suddenly smashes table: 'ESHKOL SMASH... but diplomatically!' Victory montage: Territory triples in 6 days, Spider-Man meme pointing at map: 'How did we get Sinai?' Death scene like Tony Stark: 'I... united... Jerusalem...' fades to dust. Post-credit: Golda Meir's cigarette smoke forms ominous cloud." \
...
if [ $? -eq 0 ]; then
    ...
    python main.py generate \
      --mission "Marvel accident: Ehud Olmert becomes PM like Spider-Man, 'I didn't ask for this!' Lebanon War 2: Launches operation like Iron Man 1 - everything goes wrong. Winograd Commission like SHIELD investigation. Secret peace talks: offers Jerusalem like offering Infinity Gauntlet. Corruption trials multiply like Hydra heads - envelopes of cash rain down. Prison suit fitting like Iron Man armor removal. Actually goes to jail - first PM in prison stripes. 'I almost made peace!' echoes in cell. Post-credit: Writing memoir, 'If only they knew what I offered...'" \
