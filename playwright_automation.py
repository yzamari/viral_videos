...
class VideoGeneratorAutomation:
    def __init__(self):
        ...
        self.heroes = [
            ...
            {
                "name": "Ilan Ramon",
                "mission": "Ilan Ramon: Israel's first astronaut and national hero who carried the nation's pride to space. A fighter pilot who destroyed Iraq's nuclear reactor in 1981, he brought kosher food and a Holocaust survivor's drawing to the Space Shuttle Columbia. His tragic death in 2003 united a nation in mourning for a true mensch among men.",
                "platform": "youtube",
                "category": "Educational",
                "duration": 50
            },
    ...
    async def generate_hero_video(self, hero_data):
        ...
        async with async_playwright() as p:
            ...
            try:
                ...
                # Fill in the form
                await page.fill('textarea[placeholder*="Enter your video mission"]', hero_data['mission'])
