"""
Laptop-Optimized Hollywood Pipeline (Fixed)
...
class LaptopHollywoodPipeline:
    ...
    def __init__(self,
        ...
        session_id = session_manager.create_session(
            mission=f"hollywood_movie_{timestamp}",
            platform="youtube",
    ...
    def generate_5_minute_movie(self,
                                concept: str,
                                genre: str = "drama",
                                style: str = "cinematic",
    ...
    def _plan_movie_efficiently(self,
                                concept: str,
                                genre: str,
                                style: str,
        ...
        # Generate new plan - wrap async call
        import asyncio
        try:
        ...
        blueprint = loop.run_until_complete(self.scene_planner.plan_hollywood_movie(
            concept=concept,
            genre=genre,
            style=style,
    ...
    def _generate_character_refs_cached(self,
        ...
        for char_name, char_data in movie_plan.characters.items():
            ...
            if os.path.exists(cache_path) and self.config.cache_references:
                ...
                if not test_mode:
                    ...
                    ref = loop.run_until_complete(self.continuity_engine.create_character_reference(
    ...
    def _generate_scenes_batched(self,
                                 movie_plan: MovieScript,
                                 character_refs: Dict,
        ...
        for batch_idx in range(0, len(movie_plan.scenes), batch_size):
            ...
            batch_clips = self._generate_batch_parallel(
    ...
    def _generate_batch_parallel(self,
        ...
        # Generate sequentially for laptop optimization
        clips = []
        for scene in batch:
            clip = self._generate_single_scene(
    ...
    def _generate_single_scene(self,
        ...
        try:
            # Generate with VEO
            clip_path = self._generate_veo_clip_with_retry(
    ...
    def _generate_veo_clip_with_retry(self,
                                      scene: Scene,
                ...
                for char in scene.characters:
                    if char in character_refs:
                        ...
                        try:
                            ...
                            # Use simple dict if enhanced client not available
                            pass
    ...
    def _generate_music_efficiently(self,
                                   movie_plan: MovieScript,
                                   test_mode: bool) -> str:
    ...
    def _assemble_movie_efficiently(self,
